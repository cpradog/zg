...
pub const Unmanaged = struct {
    ...
    pub fn init(allocator: mem.Allocator) !Unmanaged {
    ...
    pub fn deinit(self: *const Unmanaged, allocator: mem.Allocator) void {
...
pub fn init(allocator: mem.Allocator) !Self {
    return .{
        .allocator = allocator,
        .unmanaged = try Unmanaged.init(allocator),
    };
}
